...
local smtp_session = require "modules.protocols.relay.smtp.smtp_session"
local smtp_data = require "modules.protocols.relay.smtp.smtp_data"
...
modules.protocols.relay.smtp = smtp_context
