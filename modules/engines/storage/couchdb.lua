...
function couchdb_new.new(data, contents)
    ...
    self.where = config.modules.engines.storage.couchdb.uri()
...
slimta.config.new("config.modules.engines.storage.couchdb.uri", "tcp://localhost:5984")
slimta.config.new("config.modules.engines.storage.couchdb.queue", "queue")

modules.engines.storage.couchdb = {
    new = couchdb_new,
