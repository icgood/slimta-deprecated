...
local arh = slimta.policies.add_received_header.new()
...
assert(message.contents.headers.received[1] == "from testing (unknown [1.2.3.4]) by myhost.tld (slimta 0.0) with SMTP for <recipient@domain.com>; Fri, 13 Feb 2009 23:31:30 +0000 (UTC)")
